...
public class Dino : Pet, IDamagable {
    ...
    public Dino(int maxHappiness, int maxHunger, int startingHappiness, int startingHunger, float timerLength, int power, int agility,int health, int intelligence, int stamina, float weight) : base(maxHappiness, maxHunger, startingHappiness, startingHunger, timerLength,power,agility,health,intelligence,stamina, weight) {
